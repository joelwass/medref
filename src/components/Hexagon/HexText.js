...
class HexText extends Component {
  ...
  render() {
    ...
    return (
      <TSpan x={x || 0} y={y ? y : '0.1em'} >
        <SvgText x={x || 0} y={y ? y : '0.1em'} fill="#000" fontWeight="bold" fontSize={fontsize} textAnchor="middle" onPress={() => alert("Clicked Text")}>{children}</SvgText>
      </TSpan>
